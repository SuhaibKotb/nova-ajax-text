...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-nova-ajax-text', __webpack_require__(3));
  Vue.component('detail-nova-ajax-text', __webpack_require__(6));
  Vue.component('form-nova-ajax-text', __webpack_require__(9));
});
